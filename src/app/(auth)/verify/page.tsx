...
async function Page() {
    ...
    return (
        <section className='w-full h-dvh grid place-items-center'>
            <img className='absolute inset-0 w-full h-full object-cover' src="https://cdn.dribbble.com/users/720738/screenshots/3008140/media/262ca14adca124e2c316b027e479c638.gif" alt="" />
