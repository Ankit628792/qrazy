...
export const chartData = [
    {
        id: "January",
        "Britania Biscuit": getRandomNumber(50, 400),
        "Parle-G": getRandomNumber(50, 400),
        "Coca Cola": getRandomNumber(50, 400),
        "Pepsi": getRandomNumber(50, 400),
        "Maggi Noodles": getRandomNumber(50, 400)
    },
    {
        id: "February",
        "Britania Biscuit": getRandomNumber(50, 400),
...
export const generateChartConfig = (chartData: MonthData[]): ChartConfig => {
    ...
    const chartConfig: ChartConfig = productKeys.reduce((config, product, index) => {
