...
function QRs() {
  const [products] = useState(generateRandomProducts(20))
  ...
  return (
    <section className="flex gap-4 items-start">
      <div className="grid grid-cols-12 gap-4 flex-grow">
        <div className="col-span-12 lg:col-span-7 flex flex-col gap-6">
          <AreaChartGradient
            ...
            Navigate={
              <Link href={'/qrs/order'} className="absolute top-3 right-3">
      ...
      <div className="bg-white dark:bg-black overflow-hidden absolute bottom-5 right-5 w-full max-w-xs rounded-lg hidden xl:flex flex-col h-80">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d249117.6674063128!2d77.19572370698737!3d28.67848108321333!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1729966817181!5m2!1sen!2sin"
          style={{ border: 0 }}
          width={340}
          height={500}
          loading="lazy"
