        ...
        <Table className='product-table text-center !border-spacing-y-0'>
            <TableHeader>
                <TableRow className='text-center'>
                    ...
                    <TableHead className='min-w-32 text-center'>Reported</TableHead>
                </TableRow>
            </TableHeader>
            <TableBody>
                {
                        ...
                        return (
                            <TableRow key={item.id}>
                                ...
                                <TableCell className="min-w-40 text-left cursor-pointer">
                                    <h1 className='sm:text-base font-semibold opacity-90 line-clamp-1'>{item.title}</h1>
                                    <p className='!line-clamp-1 text-sm font-light tracking-wide text-gray-500 py-0.5'>{item.category.name}</p>
                                </TableCell>
                                <TableCell>
                                    {item.username}
                                </TableCell>
