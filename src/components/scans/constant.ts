...
export const dummyLocations = Array(100).fill(1).map(() => {
    let dt = {
...
export const dummyScans = Array(10).fill(1).map(() => {
    let dt = {
        id: 1,
        ...
        username: "Md. Devender",
        region: "Pakistan",
        reward: faker.commerce.price({ min: 1, max: 20 }),
