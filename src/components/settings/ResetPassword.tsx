        ...
        <div className='w-full rounded-3xl bg-white dark:bg-black bg-opacity-50 dark:bg-opacity-50 backdrop-blur-sm p-3 lg:sticky lg:top-72'>
            ...
            <div className='bg-white dark:bg-black p-4 rounded-2xl flex flex-col gap-0.5'>
                <div>
                    ...
                    <Input type='password' id='currentPassword' placeholder='Type here...' />
                    <p className='error'>{"Error here"}</p>
                </div>
                <div>
                    <Label htmlFor='newPassword'>New Password</Label>
                    <Input type='password' id='newPassword' placeholder='Must contain alphanumeric, special & min 8 chars' />
                    <p className='error'>{"Error here"}</p>
                </div>
                <div>
                    <Label htmlFor='confirmPassword'>Re-enter Password</Label>
                    <Input type='password' id='confirmPassword' placeholder='Verify your password' />
