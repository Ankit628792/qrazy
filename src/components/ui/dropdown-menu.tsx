          ...
          items.map((item, i) => {
            return (
              <DropdownMenuCheckboxItem
                ...
                onCheckedChange={() => onChange(item.id, !item.checked)}
              >
                {item.label}
              </DropdownMenuCheckboxItem>
            )
...
export function Dropdown({ children, label, items, handleClick }: {
  children: React.ReactNode,
  label: string,
  items: string[]
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuSeparator />
        {
          items.map((item, i) => {
            return (
              <DropdownMenuItem className="capitalize cursor-pointer" key={i} onClick={() => handleClick(item)}>
                {item}
              </DropdownMenuItem>
            )
          })
